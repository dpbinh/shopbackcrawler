...
public class CSVWordpressExporterImpl extends AbstractCSVExporterImpl<ExportTemplate> {
    @Override
    protected String getFileName() {
        Date date = new Date();
        return "WORDPRESS" + date.getDay() + "_" + date.getMonth() + "_" + date.getYear() + "_" +
    ...
    protected List<String> getRecords(ExportTemplate exportTemplate) {
        ...
        record.add(exportTemplate.getGroupId());
    ...
    protected List<String> getHeader() {
        return Arrays.asList(new String[] {
                "GroupID", "Handle", "Title", "Body (HTML)", "Vendor", "Type", "Tags",
                ...
                "Google Shopping / Gender", "Google Shopping / Google Product Category", "SEO Title",
